"""Decodifica .texture (chnkdata) -> PNG (solo mip 0)."""
import sys
...
if __name__ == '__main__':
    A = os.path.join(os.environ.get('TLS_ROOT', '.'), r'assets\pack\filesystem\data\texture')
    OUT = os.path.join(os.environ.get('TLS_ROOT', '.'), r'tools\tex_out')
